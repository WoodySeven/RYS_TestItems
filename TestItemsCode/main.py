...
from RYS_Test_Code.ranzhi_login_testcodes.ranzhi_login_test import RanzhiLogin #调用自写的测试用例的类
...
if __name__ == "__main__":
    ...
    try:
        ...
        suite.addTest(loader.loadTestsFromTestCase(RanzhiLogin)) #把RanzhiLogin测试类里的所有的方法加载到suite里
